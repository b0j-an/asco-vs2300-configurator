...
export function Sidebar({ toggleMesh, ...props }) {
  const handleToggleMeshClick = () => {
    ...
    changeClassName();
    !wasPressed1
      ? (setpriceOfMachine(priceOfMachine + 500),
        setRubberPrice('-500€'),
        setwasPressed1(true))
      : (setpriceOfMachine(priceOfMachine - 500),
        setRubberPrice('+500€'),
        setwasPressed1(false));

    buttonText === 'Remove Rubber'
      ? setButtonText('Add Rubber')
      : setButtonText('Remove Rubber');
  };
  ...
  const [buttonText2, setButtonText2] = useState('Show Options');
    ...
    <div className="Sidebar">
      ...
      <div className="sidebar-inside-bottom">
        ...
        <div className="button-container">
          <div className="price-change" onClick={handleToggleMeshClick}>
            {rubberPrice}
          </div>
          ...
          {open && (
            <Popup
              ...
              <h2>
                Uniquely designed adjustable rubber brake for controlled
                screening.
              </h2>
              <p>
                The screening process begins with the feeding of the material at
                the hopper of the screen deck. Different materials can be
                screened with different grain sizes. The material dosed via an
                adjustable rubber brake allows maximum variability in dosing.
              </p>
        ...
        <div className="button-container">
          <button className="btn" onClick={handleTrichter}>
            {buttonText4}
          </button>
        ...
        <button
          ...
          onClick={props.plej}
          onMouseEnter={() => {
            setButtonText2('Play Animation');
          }}
          onMouseLeave={() => {
            setButtonText2('Show Options');
          }}>
          {buttonText2}
        </button>
